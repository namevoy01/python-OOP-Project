...
#                     for destination_province in bus_controller.get_province_lst:
#                         if destination_province.get_province_name == target_destination_province:
#                             for route in destination_province.get_route_lst:
#                                 destination_station.add(route.get_destination_station)

#     print(list(destination_station))
